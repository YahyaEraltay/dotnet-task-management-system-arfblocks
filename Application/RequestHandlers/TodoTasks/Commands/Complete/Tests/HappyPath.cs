// namespace Application.RequestHandlers.TodoTasks.Commands.Complete.Test;
...
//     {
//         var requestPayload = new Application.RequestHandlers.TodoTasks.Commands.Complete.RequestModel()
//         {
//             Id = todoTask.Id,
//         };

//         var requestOperator = new ArfBlocksRequestOperator(_dependencyProvider);
//         var response = await requestOperator.OperateInternalRequest<Application.RequestHandlers.TodoTasks.Commands.Complete.Handler>(requestPayload);
//         if (response.HasError)
//             throw new Exception(response.Error.Message);

//         response.HasError.Should().Be(false);

//         var responsePayload = (Application.RequestHandlers.TodoTasks.Commands.Complete.ResponseModel)response.Payload;
...
//         todoTaskOnDb.Status.Should().Be(TodoTaskStatus.Completed);
//     }
