namespace Application.RequestHandlers.Users.Commands.Update.Test;
...
public class HappyPath : IArfBlocksTest
{
    ...
    {
        var requestPayload = new Application.RequestHandlers.Users.Commands.Update.RequestModel()
        {
            Id = user.Id,
        ...
        var response = await requestOperator.OperateInternalRequest<Application.RequestHandlers.Users.Commands.Update.Handler>(requestPayload);
        if (response.HasError)
            throw new Exception(response.Error.Message);

        response.HasError.Should().Be(false);

        var responsePayload = (Application.RequestHandlers.Users.Commands.Update.ResponseModel)response.Payload;
